		...
		unsigned char *solve)
{
	...
	sq_s = (sq_s < (int)((char*)(lst->content))[7] - '0') ?
		(int)((char*)(lst->content))[7] - '0' : sq_s;
	sq_s = (sq_s < (int)((char*)(lst->content))[8] - '0') ?
		(int)((char*)(lst->content))[8] - '0' : sq_s;
	while (!solve)
	{
...
int				main(int argc, char **argv)
{
	...
	if (argc == 2)
	{
		if ((lst = ft_check(argv[1])))
		{
			if (ft_terms_amount(lst) < 27)
